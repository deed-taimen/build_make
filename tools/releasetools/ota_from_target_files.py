...
UNZIP_PATTERN = ['IMAGES/*', 'META/*', 'SYSTEM/build.prop']
...
""" % bcb_dev)
  ...
  if target_info.GetBuildProp("ro.xtended.version") is not None:
    buildid = target_info.GetBuildProp("ro.xtended.version")
